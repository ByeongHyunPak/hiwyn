...
class ERPDiffusion_0_1_5(ERPDiffusion_0_1_0):
    """ ERPDiffusion_0_1_1 + Global cond. guidance + Training-Free Diffusion variable size
        https://github.com/bomcon123456/training-free-diffusion-variable-sized/tree/master
    """
    ...
    def text2erp(self,
        ...
        for i, t in enumerate(tqdm(self.scheduler.timesteps)):
            ...
            ### 0.1.5 - compute global class direction score from ERP noise
            erp_unet_input = torch.cat([x_erp] * 2)
            erp_noise_pred = self.unet(erp_unet_input, t, encoder_hidden_states=text_embeds)['sample']
